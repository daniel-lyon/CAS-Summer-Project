# This file contains a bunch of useful already defined Keck related functions / routines
# DO NOT MODIFY THIS FILE BUT CALL THE FUNCTIONS DEFINED FROM MY OWN DIFFERENT PYTHON FILE

# This is a mostly literal port of x_keckhelio.pro from XIDL (http://www.ucolick.org/~xavier/IDL/)
# The referenced link is among my bookmarked files and contains some code documentation
...
#barycorr = x_keckhelio(ra=226.337, dec=1.8033, jd=2458573.997274, obs='keck')

#JD is 2458571.708333 for keck run on march 29th 2019
#JD is MJD in fits header + 2400000.5

#print("The Barycentric Correction is %.3f km/s. [BEWARE THE SIGN - you subtract this number] \n ALSO MAKE SURE THE RA/DEC is right" % barycorr)
########################################################################################################################